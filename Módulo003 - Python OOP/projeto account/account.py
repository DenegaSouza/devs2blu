class Account:
    # Define an __init__ constructor method with attributes shared by all accou
    def __init__(self,acct_nbr,opening_deposit):
        self.acct_nbr = acct_nbr
        self.balance = opening_deposit

    
    # Define a __str__ mehthod to return a recognizable string to any print() c
    def __str__(self):
...
class Checking(Account):
    ...
    # Define a __str__ method that returns a string specific to Checking accoun
    @property
    def __str__(self):
        return f'Checking Account #{self.acct_nbr}\n Balance: {Account.__str__}'
